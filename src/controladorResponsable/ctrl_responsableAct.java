 ...
 * @author JOSE-MA
 */
public class ctrl_responsableAct {
    ...
    public ctrl_responsableAct(vista_responsable vista_responsable) {
    ...
    public void IniciarVistaResponsable() {
        ...
        vista_responsable.titulo.setText("ACTUALIZAR RESPONSABLE");
        vista_responsable.accion.setText("Actualizar");
        try {
            ...
            dt = respoDAO.obtenerResponsables("", "");
        ...
        vista_responsable.accion.addActionListener((ActionEvent e) -> {
            if (vista_responsable.identificacion.getText().equals("")) {
                ...
                try {
                    ...
                    responsable.setContacto(vista_responsable.contacto.getText());
                    ...
                    if (respoDAO.actualizarResponsable(responsable) == 1) {
                        JOptionPane.showMessageDialog(vista_responsable, "Responsable actualizado correctamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
        ...
        vista_responsable.tabla.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ...
                    vista_responsable.direccion.setText(dt.getValueAt(row, 5).toString());
                    vista_responsable.telefono.setText(dt.getValueAt(row, 6).toString());
                    vista_responsable.contacto.setText(dt.getValueAt(row, 7).toString());
                } catch (SQLException ex) {
                    JOptionPane.showMessageDialog(vista_responsable, ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
