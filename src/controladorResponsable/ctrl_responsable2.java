 ...
 * @author JOSE-MA
 */
public class ctrl_responsable2 {
    ...
    private final vista_responsable2 vista_responsable;
  private final ValidarCedula validarCedula;
...
//    private final ProvinciaDAO provinciaDAO;
    ...
    public ctrl_responsable2(vista_responsable2 vista_responsable) {
        this.validarCedula = new ValidarCedula();
...
//            provinciaDAO.ObtenerListaProvincia();
    ...
    private void eventos() {
        ...
        vista_responsable.accion.addActionListener((ActionEvent e) -> {
             if (validarCedula.validadCedula(vista_responsable.identificacion.getText())) {
            if (vista_responsable.identificacion.getText().equals("")) {
                ...
                try {
                    ...
                    if (respoDAO.insertarResponsable(responsable) == 1) {
                        ...
                        vista_responsable.direccion.setText("");
                ...
                JOptionPane.showMessageDialog(vista_responsable, "Cedula incorrecta", "Error", JOptionPane.ERROR_MESSAGE);
            }
